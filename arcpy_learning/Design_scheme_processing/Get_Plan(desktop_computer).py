...
if __name__ == '__main__':
    ...
    Merge_Plan.Model_For_Part_Entirety_Replace(
        ...
        plan=r"E:\DataBase_本地更新库\湛江市国土空间规划\Database\中心城区方案.gdb\中心城区方案到中心线20230620",  # 微调版需要更换
        ...
        range=r"E:\DataBase_本地更新库\湛江市国土空间规划\Database\中心城区方案.gdb\中心城区范围线20230601_县级库",
        entirety_replace_part=r"E:\DataBase_本地更新库\湛江市国土空间规划\Database\中心城区方案.gdb\PTMZ用地方案20230612",
        ...
        kfbj=r"E:\DataBase_本地更新库\湛江市国土空间规划\湛江市国土空间规划.gdb\微调城镇开发边界_赤坎霞山",  # 微调版需要更换
    ...
    # # 消除碎图斑
    # eliminate_under_200.eliminate_under_200(input_file=r'E:\DataBase_本地更新库\湛江市国土空间规划\Output_Database.gdb\complete_plan_20230620_WT',
    #                                         styn=r'E:\DataBase_共享总库\ZJ\04_三区三线试划\成果_20221110-广东省“三区三线”划定成果矢量数据（部下发封库版）\三区三线下发版.gdb\STBHYN_d',
    #                                         output_file=r'E:\DataBase_本地更新库\湛江市国土空间规划\Output_Database.gdb\complete_plan_20230620_WT_E',
    #                                         jsyd=r'E:\DataBase_本地更新库\湛江市国土空间规划\湛江市国土空间规划.gdb\变更调查2020建设用地')
